...
Project Structure
Your project should be in a single folder (of your name) which needs to be uploaded in the respective domain folder. There should be no .git folders in your project, because IEEE-LEAD-6.0 is itself a git repository and repositories can't be nested.
...
Go to your forked repository. Notice that the end of the URL should resemble <your_github_username>/IEEE-LEAD-6.0.
...
After cloning is done, confirm that a folder named IEEE-LEAD-6.0 is present in your current working directory.
Now, Follow the below steps for submitting each Project:

Copy your project folder.
Paste it in the local clone of IEEE-LEAD-6.0 (created in the above steps), inside the respective Project folder.
Rename your Project folder to your Full name.
Now, Right-click and open gitbash in the IEEE-LEAD-6.0 folder, and issue the following commands in order:
git add .
